...
namespace PTCE_NS {
	...
	namespace PTCE_TOOL_NS {
		...
		enum {
			PTCE_PARAMETER_EXCEPTION_DUPLICATE_PARAMETER = 0,
			PTCE_PARMAETER_EXCEPTION_EMPTY_PARAMETER,
		...
		static const std::string PTCE_PARAMETER_EXCEPTION_STR[] = {
			PTCE_PARAMETER_HEADER " Duplicate parameter",
			PTCE_PARAMETER_HEADER " Empty parameter",
			PTCE_PARAMETER_HEADER " Invalid parameter",
			PTCE_PARAMETER_HEADER " Invalid parameter argument",
